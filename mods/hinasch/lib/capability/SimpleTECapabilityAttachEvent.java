...
public abstract class SimpleTECapabilityAttachEvent<K> extends SimpleCapabilityAttachEvent<AttachCapabilitiesEvent.TileEntity,K>{



	public SimpleTECapabilityAttachEvent(String modid, boolean serialize) {
		super(modid, serialize);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	public SimpleTECapabilityAttachEvent(String modid, boolean serialize,
			mods.hinasch.lib.capability.SimpleCapabilityAttachEvent.IPreAttach preAttach) {
		super(modid, serialize, preAttach);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	@SubscribeEvent
	public void attach(final AttachCapabilitiesEvent.TileEntity ev){
