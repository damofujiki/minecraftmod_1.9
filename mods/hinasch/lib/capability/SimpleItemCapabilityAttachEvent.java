...
public abstract class SimpleItemCapabilityAttachEvent<K> extends  SimpleCapabilityAttachEvent<AttachCapabilitiesEvent.Item,K>{



	public SimpleItemCapabilityAttachEvent(String modid, boolean serialize) {
		super(modid, serialize);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	public SimpleItemCapabilityAttachEvent(String modid, boolean serialize, IPreAttach preAttach) {
	...
	@SubscribeEvent
	public void attach(final AttachCapabilitiesEvent.Item ev){
