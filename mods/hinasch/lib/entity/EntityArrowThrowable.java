...
//
//public class EntityArrowThrowable extends EntityThrowable implements IProjectile
//{
//    private int xTile = -1;
//    private int yTile = -1;
//    private int zTile = -1;
...
//
//    public EntityArrowThrowable(World par1World)
//    {
//        super(par1World);
...
//    }
//
//    public EntityArrowThrowable(World par1World, double par2, double par4, double par6)
//    {
//        super(par1World);
//        this.renderDistanceWeight = 10.0D;
//        this.setSize(0.5F, 0.5F);
...
//    }
//
//    public EntityArrowThrowable(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
//    {
//        super(par1World);
//        this.renderDistanceWeight = 10.0D;
...
//    }
//
//    public EntityArrowThrowable(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
//    {
//        super(par1World);
//        this.renderDistanceWeight = 10.0D;
//        this.shootingEntity = par2EntityLivingBase;
...
//    {
//        if (!this.worldObj.isRemote && this.inGround && this.throwableShake <= 0)
//        {
...
//            if (movingobjectposition.entityHit != null)
//            {
//            	if(movingobjectposition.entityHit == this.shootingEntity)return;
//                f2 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
//                int i1 = MathHelper.ceiling_double_int((double)f2 * this.damage);
//
//                if (this.getIsCritical())
...
//                this.inData = inTile.getMetaFromState(worldObj.getBlockState(new BlockPos(this.xTile, this.yTile, this.zTile)));
//                this.motionX = (double)((float)(movingobjectposition.hitVec.xCoord - this.posX));
//                this.motionY = (double)((float)(movingobjectposition.hitVec.yCoord - this.posY));
//                this.motionZ = (double)((float)(movingobjectposition.hitVec.zCoord - this.posZ));
//                f2 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
...
//
//                if (this.inTile.isAir(worldObj, new BlockPos(xTile, yTile, zTile)))
//                {
//                    this.inTile.onEntityCollidedWithBlock(this.worldObj,  new BlockPos(xTile, yTile, zTile), this);
//                }
//            }
//        }
//
